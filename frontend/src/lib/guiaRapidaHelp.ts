...
export const GUIA_PASOS = [
  ...
  { n: 4, titulo: "Diagnóstico", ruta: "/evaluaciones", detalle: "Ejecute la evaluación desde la cabina — no desde laboratorios demo." },
  { n: 5, titulo: "Oportunidades", ruta: "/oportunidades", detalle: "Revise oportunidades detectadas y priorice atención." },
  { n: 6, titulo: "Solución IA", ruta: "/evaluaciones", detalle: "EIAAX propone empleados, automatizaciones y arquitectura; usted revisa y autoriza." },
  ...
  { n: 9, titulo: "Propuesta y contrato", ruta: "/evaluaciones", detalle: "Gestione etapa comercial desde la pestaña Contrato de la cabina." },
  ...
  { n: 12, titulo: "Resultados", ruta: "/resultados", detalle: "Compare antes, proyectado y real." },
  { n: 13, titulo: "Informe", ruta: "/comunicaciones", detalle: "Genere o programe informes periódicos." },
  { n: 14, titulo: "Vista Empresa", ruta: "/evaluaciones", detalle: "Publique exactamente lo que verá la entidad." },
