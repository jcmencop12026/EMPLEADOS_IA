...
SUPPORTED_EVENTS = {
    ...
    "SUPPORT_CASE_COMMENT", "SUPPORT_SLA_WARNING", "SUPPORT_CASE_ESCALATED",
    "EMPLOYEE_AUDIT_CRITICAL", "EMPLOYEE_AUDIT_INTERVENTION",
    "COMMUNICATION_SENT",
}
...
DEFAULTS = {
    ...
    "EMPLOYEE_AUDIT_CRITICAL": ("WARNING", "CRITICAL", "Hallazgo crítico en empleado IA"),
    "EMPLOYEE_AUDIT_INTERVENTION": ("WARNING", "HIGH", "Empleado IA requiere intervención"),
}
