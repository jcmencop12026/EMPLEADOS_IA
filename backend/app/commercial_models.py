...
class CommercialPlan(Base):
    ...
    sector_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    base_plan_id: Mapped[str | None] = mapped_column(String(36), ForeignKey("commercial_plans.id"), nullable=True)
...
class CommercialProposal(Base):
    ...
    package_version_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    plan_version_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    segment_id: Mapped[str | None] = mapped_column(String(36), nullable=True)
    profile_snapshot_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    catalog_snapshot_json: Mapped[str | None] = mapped_column(Text, nullable=True)
    credential_mode: Mapped[str] = mapped_column(String(30), nullable=False, default="IA_ADMINISTRADA")
