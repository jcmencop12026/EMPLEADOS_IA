...
def upload_dataset(
    ...
    check_permission(user, "salud.cargar_datos")
...
def ejecutar_analisis(
    ...
    check_permission(user, "salud.ejecutar_analisis")
...
def obtener_diagnostico(
    ...
    check_permission(user, "salud.consultar_diagnostico")
...
def crear_plan_accion(
    ...
    check_permission(user, "salud.aceptar_recomendaciones")
    ...
    return {"id": plan.id, "titulo": plan.title, "tareas": json.loads(plan.tasks_json)}
...
def casos_similares(
    ...
    check_permission(user, "salud.administrar_experiencia")
...
def demo_datasets(user: User = Depends(get_current_user)):
    check_permission(user, "salud.consultar_diagnostico")
