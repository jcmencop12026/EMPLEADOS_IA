...
FK_FINOPS_RECORDS_OPPORTUNITY = "fk_finops_records_opportunity_id"
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("finops_records") as batch_op:
        batch_op.drop_constraint(FK_FINOPS_RECORDS_OPPORTUNITY, type_="foreignkey")
