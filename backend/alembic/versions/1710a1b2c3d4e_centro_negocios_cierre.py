...
def upgrade() -> None:
    ...
    with op.batch_alter_table("negocio_proposal_versions") as batch_op:
...
def downgrade() -> None:
    ...
    with op.batch_alter_table("negocio_proposal_versions") as batch_op:
        batch_op.drop_constraint("fk_negocio_ver_approved_by", type_="foreignkey")
        batch_op.drop_constraint("fk_negocio_ver_presented_by", type_="foreignkey")
        batch_op.drop_constraint("fk_negocio_ver_pdf_doc", type_="foreignkey")
